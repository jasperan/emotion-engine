...
from emotionsim.agents import HumanAgent, EnvironmentAgent, DesignerAgent
...
class TestAgentTick:
    ...
    async def test_environment_agent_tick(self):
        ...
        with patch("emotionsim.agents.base.LLMRouter.generate_with_fallback", mock_generate):
