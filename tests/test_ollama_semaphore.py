...
async def test_semaphore_limits_concurrency():
    ...
    from emotionsim.llm.ollama import get_llm_semaphore, reset_llm_semaphore
    reset_llm_semaphore()

    with patch("emotionsim.llm.ollama.get_settings") as mock_settings:
        ...
        mock_settings.return_value.ollama_api_key = "ollama"  # pragma: allowlist secret
...
async def test_vram_check_warm_model():
    ...
    from emotionsim.llm.ollama import check_model_warm
    with patch("emotionsim.llm.ollama.httpx.AsyncClient") as mock_cls:
